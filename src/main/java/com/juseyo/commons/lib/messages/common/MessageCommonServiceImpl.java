/**
 * @file			MessageCommonServiceImpl.java
 * @brief   	공통파트에서 사용될 메시지 처리의 서비스  
 * @author  	개발1팀 / 파트5
...
//		return getConfiguration().getStringArray(name);
	 ...
	 */
	private ExtendedProperties getConfiguration() throws Exception {
	 ...
	 * @param extFileName
	 */
	public void setExtFileName(Set<?> extFileName) throws Exception {
