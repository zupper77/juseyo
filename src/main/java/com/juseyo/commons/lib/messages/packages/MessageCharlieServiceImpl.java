/**
 * @file			MessageChalieServiceImpl.java
 * @brief   	3팀에서 사용될 메시지 처리의 서비스  
 * @author  	개발1팀 / 파트5
...
public class MessageCharlieServiceImpl implements MessageService, InitializingBean, DisposableBean, ResourceLoaderAware {
