/**
 * @file			ThrowingBravoInterceptor.java
 * @brief   	2팀용 인터셉터 ( 에러처리 전용 ) 
 * @author  개발1팀 / 파트5
...
/**
* @brief 	ThrowingBravoInterceptor
* @author 	개발1팀 / 파트5
* @version 1.0
* @date    생성: 2014-03-14
* @date    최종수정: 2014-03-14
...
*/
@Aspect
public class ThrowingBravoInterceptor {
	...
	public void pointcut4throwingLog() {}
	 ...
	 /**
	 * @brief		모든 호출에 대한 exception 처리 (2 팀용 )
	 * @details	
	 * @param 	joinPoint
	 * @throws Exception
	 * @return		
